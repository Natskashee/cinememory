...
<body class="flex bg-daintree-900">
    ...
    <div class="h-fit w-full flex justify-center text-white flex-col pl-64">
        <div class="flex flex-col h-[50vh] bg-center bg-cover w-full banner-index bg-fixed" style="background-image: url('/images/The Last of Us II.jpg');">
		...
		c-6.7-6.7-6.8-17.4-0.3-24C420.2,176.5,430.9,176.6,437.6,183.3z" />
            ...
            <div class="h-full flex items-center gap-6 justify-center pl-24 pr-4">
