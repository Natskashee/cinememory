...
<body class="flex bg-daintree-900">
    ...
    <div class="sidebar fixed pt-4 bg-daintree-800 flex flex-col h-screen shadow-lg w-1/6 text-white">
        <a href="{{route('post.index')}}" align="center" class="text-sky-500 font-bold text-xl title"> <span class="text-white">Cine</span>memory</a>
    ...
    <div class="h-fit w-full flex justify-center text-white flex-col pl-64">
        <div class="flex justify-between items-center mx-auto my-2 w-full">
            <div class="pl-24">
            ...
            <form action="{{ route('post.search') }}" method="GET" class="search gap-3">
                <input type="search" name="query" id="" class="px-5 py-2 bg-daintree-800 rounded-full text-white" placeholder="Rechercher">
        ...
        <div class="fixed h-screen w-screen top-0 left-0 bg-daintree-900 flex justify-center items-center z-50 flex-col gap-10 search-div show">
            <a href="{{route('post.index')}}" class="text-4xl font-bold text-white">Cine<span class="text-sky-600">memory</span></a>
