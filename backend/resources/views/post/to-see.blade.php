...
<div class="border-b-2 border-sky-600 w-5/6 ml-24 pt-6">
    <h1 class="text-white flex gap-4 uppercase">
        Mes séries et films A voir
    </h1>
</div>

<div class="flex justify-center flex-wrap mt-6 w-full bg-center bg-cover" style="background-image: url('/images/plygon-scatter-haikei.svg');">
    @foreach($posts as $post)
    @if($post -> statut === "A voir")
    <div class="pr-4 mb-4">
